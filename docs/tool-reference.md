...
- validation fails on absolute manifest paths, empty source lists, missing
  source files, duplicate source entries, non-`.zpp` source paths, or generated
  artifact paths with the wrong extension
- audit errors fail
